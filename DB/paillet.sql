...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2018 a las 17:29:44
...
(3, 'parpados.jpg', 'Texto sobre PARPADOS', 'PARPADOS', '/pagina/parpados'),
...
INSERT INTO `subseccion` (`id_subseccion`, `imagen`) VALUES
(1, 'slider2-1.jpg'),
(2, 'facial.jpg'),
(3, 'fondo_contact.jpg');
...
--
ALTER TABLE `cirugias`
  MODIFY `id_cirugias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `subseccion`
  MODIFY `id_subseccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
