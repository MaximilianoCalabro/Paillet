...
class CorporalController extends Controller
{
	public function index()
	{
		...
		return view('/pagina/corporal',["inicio"=>$inicio, "cirugia"=>$cirugia, "cirugias"=>$cirugias, "cirugia_slider"=>$cirugia_slider, "contacto"=>$contacto, "cv"=>$cv, "cv_lista"=>$cv_lista, "cv_plastica"=>$cv_plastica, "clinica"=>$clinica, "liposuccion"=>$liposuccion, "abdominoplastia"=>$abdominoplastia, "pantorrillas"=>$pantorrillas, "gluteos"=>$gluteos]);
	}
}
