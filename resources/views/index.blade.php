...
<section class="header-uper">
      <div class="container clearfix">
            <div class="logo">
                <figure>
                    <a href="index.html">
                        <img src="{{asset('img/logo.jpg')}}" alt="" width="130">
                    </a>
                </figure>
            </div>
      </div>
...
<!--Start about us area-->
<section class="service-tab-section section" id="cir">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-12 col-xs-12">
            <a href="https://www.plasticsurgery.org/" target="_blank">
              <img class="media-object" src="{{asset('img/icon1.png')}}" alt="post-thumb">
            </a>
        </div>
        <div class="col-md-3 col-sm-12 col-xs-12">
            <a href="http://www.scperrl.org/" target="_blank">
              <img class="media-object" src="{{asset('img/icon4.png')}}" alt="post-thumb">
            </a>
        </div>
        <div class="col-md-3 col-sm-12 col-xs-12">
            <a href="http://www.sacper.org.ar/www/" target="_blank">
              <img class="media-object" src="{{asset('img/icon2.png')}}" alt="post-thumb">
            </a>
        </div>
        <div class="col-md-3 col-sm-12 col-xs-12">
            <a href="https://www.isaps.org/es/" target="_blank">
              <img class="media-object" src="{{asset('img/icon3.png')}}" alt="post-thumb">
            </a>
        </div>
      </div>
    </div>
