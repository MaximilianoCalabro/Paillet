...
@section ('cirugia')
    ...
    <div class="tabs">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#dormitory"  data-toggle="tab">{{ $lifting[0]->nombre }}</a>
            </li>
            <li role="presentation">
                <a href="#orthopedic" data-toggle="tab">{{ $dermoabrasion[0]->nombre }}</a>
            </li>
            <li role="presentation">
                <a href="#sonogram" data-toggle="tab">{{ $peeling[0]->nombre }}</a>
            </li>
        </ul>
    </div>
    ...
    <div class="tab-content">
        <div class="service-box tab-pane fade in active row" id="dormitory">
            <div class="col-md-6">
                <img class="img-responsive" src="{{url('/')}}/img/{{$lifting[0]->imagen}}" alt="service-image">
            </div>
...
<!--End single tab content-->
                        ...
                        <div class="service-box tab-pane fade in" id="orthopedic">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{url('/')}}/img/{{$dermoabrasion[0]->imagen}}" alt="service-image">
                            </div>
                            <div class="col-md-6"> <!-- Preguntas -->
                                <div class="contents">
                        ...
                        <div class="service-box tab-pane fade in" id="sonogram">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{url('/')}}/img/{{$peeling[0]->imagen}}" alt="service-image">
                            </div>
                            <div class="col-md-6"> <!-- Preguntas -->
                                <div class="contents">
